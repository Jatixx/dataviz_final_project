...
that size alone is not a complete predictor of price. \## Additional
Approaches As an additional approach to explore the data, future
analyses could use a multiple regression model to investigate which
other variables year built, significantly influence house prices.
