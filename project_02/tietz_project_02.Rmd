...
with the Baby Boom, a period of unusually high birth rates in the
...
As an additional approach to explore the data, future
analyses could use a multiple regression model to investigate which other variables, such as year built, significantly influence house prices.
